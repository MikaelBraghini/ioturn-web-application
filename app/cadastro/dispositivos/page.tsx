          ...
          <CardContent className="pt-6 space-y-6">
            <div className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                Para garantir a integridade e consistência dos dados, os dispositivos IoT (sensores
                Heltec V2) são cadastrados automaticamente durante o processo de{' '}
              ...
              <div className="p-4 bg-muted/50 rounded-lg border border-border space-y-3">
                ...
                <ul className="text-sm text-muted-foreground space-y-2 leading-relaxed">
                  <li className="flex gap-2">
                    ...
                    <span>
                      <strong className="text-foreground">Vinculação obrigatória:</strong> Todo
                      dispositivo deve estar associado a uma máquina específica
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-bold">•</span>
                    <span>
                      <strong className="text-foreground">Dados contextualizados:</strong> Os
                      sensores coletam dados que só fazem sentido no contexto de uma máquina
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-bold">•</span>
                    <span>
                      <strong className="text-foreground">Fluxo simplificado:</strong> Evita
                      dispositivos órfãos ou configurações incompletas
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-bold">•</span>
                    <span>
                      <strong className="text-foreground">Integridade referencial:</strong> Garante
                      que máquinas e dispositivos sejam criados em conjunto
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 bg-accent/10 rounded-lg border border-accent/20">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Você será redirecionado automaticamente para o formulário de cadastro de máquinas,
                  onde poderá registrar tanto a máquina quanto seu dispositivo IoT associado em um
                  fluxo integrado de 3 etapas.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="space-y-2">
                ...
                <ol className="text-sm text-muted-foreground space-y-1 leading-relaxed list-decimal list-inside">
                  <li>
                    Preencha as informações básicas da máquina (nome, modelo, número de série)
                  </li>
                  <li>Associe a máquina ao cliente proprietário e usuário responsável</li>
                  <li>
                    Configure o dispositivo IoT que será instalado na máquina (Node ID e Gateway)
                  </li>
