...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'hidden lg:flex lg:flex-col lg:fixed lg:inset-y-0 lg:border-r z-60 lg:border-border/50 lg:bg-card lg:shadow-xl transition-all duration-300',
      ...
      >
        ...
        <Button
          ...
          size="icon"
          className={cn(
            'absolute -right-4 cursor-pointer top-8 z-10 h-7 w-7 rounded-full border-2 border-border bg-card shadow-lg transition-all duration-200',
